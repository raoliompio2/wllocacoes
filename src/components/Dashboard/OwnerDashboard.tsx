...
import { Package2, Calendar, PenTool as Tool, Star, DollarSign, Users, MessageSquare } from 'lucide-react';
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <AnalyticCard
          title="Orçamentos"
          value={budgetRequests?.filter(req => req.status === 'pending')?.length || 0}
          icon={MessageSquare}
          color="orange"
        />
      </div>
